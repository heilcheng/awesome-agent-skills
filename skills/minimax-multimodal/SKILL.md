...
description: >
  Use when the user mentions MiniMax, wants to generate speech/voice/TTS, music/songs, video, or images
  using MiniMax AI. Also trigger when user asks about voice cloning, MiniMax APIs, multimodal generation,
  or FFmpeg media processing alongside MiniMax outputs. Trigger words: MiniMax, TTS, 语音合成, 视频生成,
  音乐生成, 图像生成, Hailuo, speech-2, Image-01, Music-2.
license: MIT
metadata:
  version: "1.0"
