...
- [go165/agent-skill-groups](https://github.com/go165/agent-skill-groups) - Runtime-aware skill groups for switching large local Agent Skills libraries by scenario
</details>
