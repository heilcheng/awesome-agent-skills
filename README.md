...
| [DevAssure](https://github.com/devassure-ai/devassure-agent-skills) | Install, configure, and run end-to-end browser tests using natural language YAML and CSV files with DevAssure CLI (`@devassure/cli`). |
