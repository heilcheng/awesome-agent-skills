...
<details>
<summary><strong>Crypto & Finance</strong></summary>

- [cymetica](https://cymetica.com/.well-known/skills/default/SKILL.md) - Trade prediction markets, clone AI trading agents, swap tokens cross-chain, verify AI-native provenance — all on-chain on Base L2. Website: [cymetica.com](https://cymetica.com). MCP server: `event-trader-mcp`
</details>
