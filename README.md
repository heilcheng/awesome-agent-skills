...
- [skyestrela/ai-agent-skill-preview](https://github.com/skyestrela/ai-agent-skill-preview) - Evidence-first code review and bug reproduction workflows with tested CLI installation and an example report
